...
object AppLanguage {
    ...
    private fun baseMap(language: String): Map<String, String> = common.mapValues { (_, values) -> values[language] ?: "" }.toMutableMap().apply {
        putAll(mapOf(
            "Pengaturan" to mapOf(ENGLISH to "Settings", MALAY to "Tetapan", TURKISH to "Ayarlar", FRENCH to "Paramètres", DUTCH to "Instellingen", ARABIC to "الإعدادات")[language]!!,
            "Waktu Sholat & Lokasi" to mapOf(ENGLISH to "Prayer Times & Location", MALAY to "Waktu Solat & Lokasi", TURKISH to "Namaz Vakitleri ve Konum", FRENCH to "Horaires de prière et localisation", DUTCH to "Gebedstijden & locatie", ARABIC to "أوقات الصلاة والموقع")[language]!!,
            "Notifikasi & Pengingat" to mapOf(ENGLISH to "Notifications & Reminders", MALAY to "Pemberitahuan & Peringatan", TURKISH to "Bildirimler ve Hatırlatıcılar", FRENCH to "Notifications et rappels", DUTCH to "Meldingen & herinneringen", ARABIC to "الإشعارات والتذكيرات")[language]!!,
            "Tampilan & Bahasa" to mapOf(ENGLISH to "Appearance & Language", MALAY to "Paparan & Bahasa", TURKISH to "Görünüm ve Dil", FRENCH to "Apparence et langue", DUTCH to "Weergave & taal", ARABIC to "المظهر واللغة")[language]!!,
            "Lainnya" to mapOf(ENGLISH to "More", MALAY to "Lain-lain", TURKISH to "Diğer", FRENCH to "Autres", DUTCH to "Meer", ARABIC to "المزيد")[language]!!,
            "Lokasi Saat Ini" to mapOf(ENGLISH to "Current Location", MALAY to "Lokasi Semasa", TURKISH to "Mevcut Konum", FRENCH to "Position actuelle", DUTCH to "Huidige locatie", ARABIC to "الموقع الحالي")[language]!!,
            "Metode Perhitungan" to mapOf(ENGLISH to "Calculation Method", MALAY to "Kaedah Pengiraan", TURKISH to "Hesaplama Yöntemi", FRENCH to "Méthode de calcul", DUTCH to "Berekeningsmethode", ARABIC to "طريقة الحساب")[language]!!,
            "Koreksi Waktu Sholat" to mapOf(ENGLISH to "Prayer Time Adjustment", MALAY to "Pelarasan Waktu Solat", TURKISH to "Namaz Vakti Ayarı", FRENCH to "Ajustement des horaires de prière", DUTCH to "Aanpassing gebedstijden", ARABIC to "تصحيح أوقات الصلاة")[language]!!,
            "Notifikasi Waktu Sholat" to mapOf(ENGLISH to "Prayer Time Notifications", MALAY to "Pemberitahuan Waktu Solat", TURKISH to "Namaz Vakti Bildirimleri", FRENCH to "Notifications des horaires de prière", DUTCH to "Meldingen voor gebedstijden", ARABIC to "إشعارات أوقات الصلاة")[language]!!,
            "Suara Adzan" to mapOf(ENGLISH to "Adhan Sound", MALAY to "Bunyi Azan", TURKISH to "Ezan Sesi", FRENCH to "Son de l’adhan", DUTCH to "Adhan-geluid", ARABIC to "صوت الأذان")[language]!!,
            "Tema Aplikasi" to mapOf(ENGLISH to "App Theme", MALAY to "Tema Aplikasi", TURKISH to "Uygulama Teması", FRENCH to "Thème de l’application", DUTCH to "Appthema", ARABIC to "مظهر التطبيق")[language]!!,
            "Bahasa Antarmuka" to mapOf(ENGLISH to "Interface Language", MALAY to "Bahasa Antara Muka", TURKISH to "Arayüz Dili", FRENCH to "Langue de l’interface", DUTCH to "Interfacetaal", ARABIC to "لغة الواجهة")[language]!!,
            "Tentang Aplikasi" to mapOf(ENGLISH to "About App", MALAY to "Tentang Aplikasi", TURKISH to "Uygulama Hakkında", FRENCH to "À propos", DUTCH to "Over de app", ARABIC to "حول التطبيق")[language]!!,
            "Kebijakan Privasi" to mapOf(ENGLISH to "Privacy Policy", MALAY to "Dasar Privasi", TURKISH to "Gizlilik Politikası", FRENCH to "Politique de confidentialité", DUTCH to "Privacybeleid", ARABIC to "سياسة الخصوصية")[language]!!,
            "Tutup" to mapOf(ENGLISH to "Close", MALAY to "Tutup", TURKISH to "Kapat", FRENCH to "Fermer", DUTCH to "Sluiten", ARABIC to "إغلاق")[language]!!,
            "Pilih Kota / Lokasi" to mapOf(ENGLISH to "Choose City / Location", MALAY to "Pilih Bandar / Lokasi", TURKISH to "Şehir / Konum Seç", FRENCH to "Choisir ville / position", DUTCH to "Kies stad / locatie", ARABIC to "اختر المدينة / الموقع")[language]!!,
            "Pilih Tema Tampilan" to mapOf(ENGLISH to "Choose Appearance Theme", MALAY to "Pilih Tema Paparan", TURKISH to "Görünüm Teması Seç", FRENCH to "Choisir le thème", DUTCH to "Kies weergavethema", ARABIC to "اختر مظهر التطبيق")[language]!!,
            "Pilih Lokasi Manual" to mapOf(ENGLISH to "Choose Manual Location", MALAY to "Pilih Lokasi Manual", TURKISH to "Manuel Konum Seç", FRENCH to "Choisir une position manuelle", DUTCH to "Kies handmatige locatie", ARABIC to "اختر الموقع يدويًا")[language]!!,
            "Atur Notifikasi" to mapOf(ENGLISH to "Notification Settings", MALAY to "Tetapan Pemberitahuan", TURKISH to "Bildirim Ayarları", FRENCH to "Réglages des notifications", DUTCH to "Meldingsinstellingen", ARABIC to "إعدادات الإشعارات")[language]!!,
            "Perbarui Lokasi" to mapOf(ENGLISH to "Refresh Location", MALAY to "Kemas Kini Lokasi", TURKISH to "Konumu Yenile", FRENCH to "Actualiser la position", DUTCH to "Locatie vernieuwen", ARABIC to "تحديث الموقع")[language]!!,
            "Mencari..." to mapOf(ENGLISH to "Searching...", MALAY to "Mencari...", TURKISH to "Aranıyor...", FRENCH to "Recherche...", DUTCH to "Zoeken...", ARABIC to "جارٍ البحث...")[language]!!,
            "Kembali" to mapOf(ENGLISH to "Back", MALAY to "Kembali", TURKISH to "Geri", FRENCH to "Retour", DUTCH to "Terug", ARABIC to "رجوع")[language]!!,

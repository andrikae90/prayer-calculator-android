...
object AppLanguage {
    ...
    private val translations: Map<String, Map<String, String>> = mapOf(
        ...
        "WIB" to mapOf(ENGLISH to "WIB", MALAY to "WIB", TURKISH to "WIB", FRENCH to "WIB", DUTCH to "WIB", ARABIC to "بتوقيت غرب إندونيسيا"),
        ...
        "Notifikasi" to mapOf(ENGLISH to "Notifications", MALAY to "Pemberitahuan", TURKISH to "Bildirimler", FRENCH to "Notifications", DUTCH to "Meldingen", ARABIC to "الإشعارات"),
        "Aktifkan notifikasi waktu salat" to mapOf(ENGLISH to "Enable prayer time notifications", MALAY to "Aktifkan pemberitahuan waktu solat", TURKISH to "Namaz vakti bildirimlerini etkinleştir", FRENCH to "Activer les notifications des prières", DUTCH to "Meldingen voor gebedstijden inschakelen", ARABIC to "تفعيل إشعارات أوقات الصلاة"),
        "Pengingat Sebelum Salat" to mapOf(ENGLISH to "Reminder Before Prayer", MALAY to "Peringatan Sebelum Solat", TURKISH to "Namaz Öncesi Hatırlatıcı", FRENCH to "Rappel avant la prière", DUTCH to "Herinnering vóór het gebed", ARABIC to "تذكير قبل الصلاة"),
        "Berapa menit sebelum waktu salat?" to mapOf(ENGLISH to "How many minutes before prayer time?", MALAY to "Berapa minit sebelum waktu solat?", TURKISH to "Namaz vaktinden kaç dakika önce?", FRENCH to "Combien de minutes avant l'heure de prière ?", DUTCH to "Hoeveel minuten voor gebedstijd?", ARABIC to "كم دقيقة قبل وقت الصلاة؟"),
        "Suara Notifikasi" to mapOf(ENGLISH to "Notification Sound", MALAY to "Bunyi Pemberitahuan", TURKISH to "Bildirim Sesi", FRENCH to "Son de notification", DUTCH to "Meldingsgeluid", ARABIC to "صوت الإشعار"),
        "Pilih suara untuk notifikasi" to mapOf(ENGLISH to "Choose a sound for notifications", MALAY to "Pilih bunyi untuk pemberitahuan", TURKISH to "Bildirimler için ses seçin", FRENCH to "Choisissez un son pour les notifications", DUTCH to "Kies een geluid voor meldingen", ARABIC to "اختر صوتًا للإشعارات"),
        "Getaran" to mapOf(ENGLISH to "Vibration", MALAY to "Getaran", TURKISH to "Titreşim", FRENCH to "Vibration", DUTCH to "Trillen", ARABIC to "الاهتزاز"),
        "Getar saat notifikasi" to mapOf(ENGLISH to "Vibrate on notification", MALAY to "Bergetar apabila ada pemberitahuan", TURKISH to "Bildirimde titreştir", FRENCH to "Vibrer lors d'une notification", DUTCH to "Trillen bij melding", ARABIC to "الاهتزاز عند الإشعار"),
    ...
    private fun mapFor(language: String): Map<String, String> =
        translations.mapValues { (key, values) -> values[language] ?: key }
